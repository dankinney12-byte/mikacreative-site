...
function WhoMikaIs() {
  ...
  }, "600K"), /*#__PURE__*/React.createElement("span", {
...
function HeroBigType({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "tag"
  }, "@_joytothefood_ \xB7 600K"), /*#__PURE__*/React.createElement("span", {
    className: "tag",
    style: {
      background: 'var(--c2)'
    }
  }, "1,001 to 600K in 24 months"), /*#__PURE__*/React.createElement("span", {
    className: "tag",
    style: {
      background: 'var(--c5)'
    }
  ...
  }, "@_joytothefood_"), " from 1,001 to 600K in two years, in the current algorithm, in a saturated niche, with a two-person team. Not in 2016 when Instagram was easy. Now.", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), "I'll show you exactly what moved the needle."), /*#__PURE__*/React.createElement("div", {
...
function HeroImageGrid({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "eyebrow"
  }, "@_joytothefood_ \xB7 600K followers \xB7 10M monthly views"), /*#__PURE__*/React.createElement("h1", {
  ...
  }, "I grew @_joytothefood_ from 1K to 600K in 24 months, in the current algorithm, in a saturated niche. I'll show you how."), /*#__PURE__*/React.createElement("div", {
...
// ============================================================
function Strip() {
  const items = ['the mastermind', 'account audit', 'in your pocket day', 'client management', 'the playbook ebook', '1k → 600K in 24 months'];
...
function About() {
  ...
  }, "Joy to the Food"), " from my kitchen in Minneapolis. In two years it went from 1,001 followers to 600K. Now we run it from wherever we want, with a toddler underfoot."), /*#__PURE__*/React.createElement("p", {
...
function Freebie() {
  ...
  }, "600K.")), /*#__PURE__*/React.createElement("p", {
