      ...
      <div className="container">
        ...
        <div className="hero-grid">
          <p className="hero-body">
            I'm Mika - engineer turned food creator. I grew <span className="mono" style={{ fontSize: '0.85em' }}>@_joytothefood_</span> from 1,001 to 440K in two years, in the current algorithm, in a saturated niche, with a two-person team. Not in 2016 when Instagram was easy. Now.
            <br /><br />
