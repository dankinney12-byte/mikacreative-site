    ...
    <section id="top" className="hero">
      <div className="container">
        <div className="hero-tags">
          <span className="tag">@_joytothefood_ · 600K</span>
          <span className="tag" style={{ background: 'var(--c2)' }}>1,001 to 600K in 24 months</span>
        ...
        <div className="hero-grid">
          <p className="hero-body">
            I'm Mika - engineer turned food creator. I grew <span className="mono" style={{ fontSize: '0.85em' }}>@_joytothefood_</span> from 1,001 to 600K in two years, in the current algorithm, in a saturated niche, with a two-person team. Not in 2016 when Instagram was easy. Now.
            <br /><br />
...
function HeroImageGrid({ onBook }) {
  ...
  const photos = [
    ...
    { c: 'var(--c4)', label: '600K screenshot · now' },
    ...
    <section id="top" style={{ paddingTop: 32, paddingBottom: 16 }}>
      <div className="container">
        ...
        <div className="hero-image-grid-content">
          <span className="eyebrow">@_joytothefood_ · 600K followers · 10M monthly views</span>
          ...
          <p className="hero-image-grid-sub">
            I grew @_joytothefood_ from 1K to 600K in 24 months, in the current algorithm, in a saturated niche. I'll show you how.
          </p>
...
function Strip() {
  const items = [
    ...
    'client management', 'the playbook ebook', '1k → 600K in 24 months',
  ];
  const Set = () => (
    <span>
      {items.map((t, i) => (
        ...
        <div className="about-grid">
          ...
          <div>
            ...
            <div className="about-text">
              ...
              <p>
                We started <strong style={{ color: 'var(--ink)' }}>Joy to the Food</strong> from my kitchen in Minneapolis. In two years it went from 1,001 followers to 600K. Now we run it from wherever we want, with a toddler underfoot.
              </p>
        ...
        <div className="card freebie-card">
          <div className="freebie-content">
            ...
            <h2 className="display freebie-headline">
              the hook formula<br />that got me to <span style={{ color: 'var(--c1)' }}>600K.</span>
            </h2>
